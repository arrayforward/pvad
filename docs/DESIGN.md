...
| 测试集 | v1 | v2 | v3 | **v4（默认）** | AS-norm 对照 |
|---|---|---|---|---|---|
| v1 干净 | 0.6% / 8.8% / 90.6% | 0.4% / 14.6% / 85.0% | 0.6% / 7.0% / 92.4% | **1.0% / 5.0% / 94.0%** | 64.8% / 0% / 35.2% |
| v2 增广 | 0.8% / 26.8% / 72.4% | 0.2% / 18.0% / 81.8% | 0.2% / 21.6% / 78.2% | **0.6% / 16.4% / 83.0%** | 74.0% / 0% / 26.0% |

C++ 生产管线口径（`double_voice --batch-list`，v4 + RNNoise 默认开，200 条/条件，
详见 [REGRESSION.md](REGRESSION.md)）：干净 1.0% / 1.5% / **97.5%**，
增广 1.5% / 16.0% / **82.5%**。
